...
function Result = Pandemic_Matlab_2()
...
% Example: Plot the state of simulation at t_index = 1
t_index = 1;
figure()
...
function Result = Covid19_Simulator(Input)
...
for h = 1: max_iter
    ...
    [health_status, health_color, sick_time] = update_recover(health_status, health_color, sick_time, recover_time);
end
...
function [health_status, health_color, sick_time] = update_recover(health_status, health_color, sick_time, max_sick_time)
% This function updates the health status, the health_color and starts the
